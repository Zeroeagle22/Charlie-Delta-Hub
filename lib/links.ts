...
export const socialLinks: SocialLink[] = [
  {
    platform: "YouTube",
    handle: "@imcharliedelta",
    url: "https://www.youtube.com/@imcharliedelta",
    icon: Youtube,
  ...
  },
  {
    platform: "Twitch",
    handle: "imcharliedelta",
    url: "https://www.twitch.tv/imcharliedelta",
    icon: Twitch,
    stat: { value: "105", label: "Followers" },
    accent: "#9146ff",
  },
  {
    platform: "Discord",
    handle: "Charlie Delta",
    url: "https://discord.gg/qkAueYSTfK",
    icon: MessageSquare,
  ...
  },
  {
    platform: "Instagram",
    handle: "@imcharliedelta",
    url: "https://www.instagram.com/imcharliedelta/",
    icon: Instagram,
    accent: "#e1306c",
  },
  {
    platform: "TikTok",
    handle: "@imcharliedelta",
    url: "https://www.tiktok.com/@imcharliedelta",
    icon: Music2,
    accent: "#69c9d0",
  },
  {
  ...
  {
    platform: "GitHub",
    handle: "CharlieDelta99",
    url: "https://github.com/CharlieDelta99",
    icon: Github,
    accent: "#a5b4fc",
  },
];
